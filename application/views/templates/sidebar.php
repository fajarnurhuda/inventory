		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('/') ?>">
				<div class="sidebar-brand-icon">
					<img class="img-profile" src="<?= base_url() ?>assets/img/favicon.png" width="50" height="50">
				</div>
				...
				<li class="nav-item">
					...
					<div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<!-- <a class="collapse-item" href="<?php echo base_url('Karyawan') ?>">Data Karyawan</a> -->
							<a class="collapse-item" href="<?php echo base_url('Ukuran') ?>">Data Ukuran</a>
			...
			<li class="nav-item">
				...
				<div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?php echo base_url('Laporan/total_masuk') ?>">Laporan Total Masuk</a>
						<a class="collapse-item" href="<?php echo base_url('Laporan/total_keluar') ?>">Laporan Total Keluar</a>
						<a class="collapse-item" href="<?php echo base_url('Laporan-barang-keluar') ?>">Laporan Excel</a>
					</div>
				</div>
			</li>
			<?php
				...
				<li class="nav-item">
					...
					<div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="<?php echo base_url('Stok') ?>">Setting Stok</a>
						</div>
					</div>
				</li>
