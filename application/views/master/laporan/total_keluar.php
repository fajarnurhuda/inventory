 ...
 <div class="container-fluid">
     ...
     <h1 class="h3 mb-4 text-gray-800">Laporan Total Keluar tes</h1>
     <div class="row mb-3">
         <div class="col-lg-12">
             <!-- Circle Buttons -->
             <div class="card shadow mb-12">
                 <div class="card-body">
                     <form method="post" action="<?= base_url('laporan/keluar_cari') ?>" autocomplete="off">
     ...
     <div class="card shadow mb-4">
         <div class="card-body">
             ...
             <a href="<?php
                        ...
                        echo base_url('Laporan/export_excel_keluar/') . $dari . '/' . $sampai . '/' . $ukur  ?>" target="_blank">
